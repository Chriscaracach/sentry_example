      ...
      <div class="slide centered">
        <div class="speaker-card">
          ...
          <div class="speaker-info">
            ...
            <h1 class="speaker-name ph">Christian Caracach</h1>
            <p class="speaker-role ph">Software Developer</p>
            <p class="speaker-company ph">CodingIT / Tiny Health</p>
            <div class="speaker-divider"></div>
            <p class="speaker-bio ph">Software developer desde hace 3 años. Creador del Club de Programación de Córdoba. Profesor de música. Músico. Me encanta pararme al frente de gente y hablar de cosas</p>
