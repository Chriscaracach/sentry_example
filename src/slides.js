...
<Sentry.ErrorBoundary fallback={<p>Error!</p>}>
  <App />
    ...
    en: {
      ...
      title: "Setup",
      description:
        "One init call. That's all it takes for Sentry to start watching.",
      points: [
...
load(); // Sentry captures this`,
    en: {
      ...
      description:
        "Anything you don't catch is captured automatically. No extra code needed.",
      points: [
    ...
    es: {
      ...
      actions: [
        ...
        {
          label: "Rechazo de promesa no controlado",
          fn: "triggerUnhandledRejection",
          danger: true,
        },
      ],
  ...
  Sentry.captureException(err, {
    ...
    en: {
      ...
      description:
        "Catch an error but still want to know it happened? Report it manually and attach context.",
      points: [
    ...
    es: {
      ...
      description:
        "¿Capturaste un error pero igual querés rastrearlo? Repórtalo manualmente y adjuntá contexto.",
      points: [
      ...
      actions: [
        ...
        {
          label: "Error controlado (simulado)",
          fn: "triggerServerHandledError",
        },
      ],
    },
  },
...
// captures will include Alice's info.`,
    en: {
      ...
      title: "User Context",
      description:
        "Attach identity to every event. Know exactly who was affected and how often.",
      points: [
      ...
      actions: [{ label: "Set user & trigger error", fn: "setUserAndError" }],
    },
    es: {
      concept: "Sentry.setUser()",
...
// Sentry event timeline.`,
    en: {
      ...
      title: "Breadcrumbs",
      description:
        "Every event includes a timeline of what happened before it. Fetch calls and console logs are captured automatically.",
      points: [
      ...
      actions: [
        {
          label: "Step 1 — Add breadcrumb & fetch",
          fn: "addBreadcrumbAndFetch",
        },
        {
          label: "Step 2 — Trigger error",
          fn: "throwUnhandledError",
          danger: true,
        },
      ],
  ...
  async () => {
    ...
    en: {
      ...
      description:
        "Go beyond errors. Wrap slow operations in a span — they appear as a waterfall in the Performance tab.",
      points: [
